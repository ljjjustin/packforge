...
./configure
TC_CONFIG_XT=y make %{?_smp_mflags}
make -C doc
...
%changelog
* Wed Mar 06 2013 Petr Šabata <contyk@redhat.com> - 3.3.0-6
- Don't propagate mounts outside of ip (#882047)

* Thu Dec 20 2012 Petr Šabata <contyk@redhat.com> - 3.3.0-5
- Add support for fq_codel (#886958)

* Thu Dec 20 2012 Petr Šabata <contyk@redhat.com> - 3.3.0-4
- Support IPv6 addresses for route's nexthop

* Wed Dec 12 2012 Petr Šabata <contyk@redhat.com> - 3.3.0-3
