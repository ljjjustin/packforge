...
# Generate doc
msgfmt %{buildroot}%{python_sitelib}/neutron/locale/zh_CN/LC_MESSAGES/neutron.po -o %{buildroot}%{python_sitelib}/neutron/locale/zh_CN/LC_MESSAGES/neutron.mo
...
rm %{buildroot}%{_sysconfdir}/neutron/plugins/opencontrail/contrailplugin.ini
...
%config  %attr(0640, root, neutron) %{_sysconfdir}/neutron/policy.json
...
%dir %{_sysconfdir}/neutron/plugins/bigswitch/ssl
%dir %{_sysconfdir}/neutron/plugins/bigswitch/ssl/ca_certs
%dir %{_sysconfdir}/neutron/plugins/bigswitch/ssl/host_certs
%{_sysconfdir}/neutron/plugins/bigswitch/ssl/ca_certs/README
%{_sysconfdir}/neutron/plugins/bigswitch/ssl/host_certs/README
...
%changelog
* Wed Sep 17 2014 Jiajun Liu <jiajun@unitedstack.com> 2014.1.2-3
- Remove quantum
