...
install -p -D -m 644 etc/keystone-paste.ini %{buildroot}%{_sysconfdir}/keystone/keystone-paste.ini
...
# Link admin and main wsgi file for Apache use
ln -sv %{_datadir}/keystone/keystone.wsgi %{buildroot}%{_datadir}/keystone/admin
ln -sv %{_datadir}/keystone/keystone.wsgi %{buildroot}%{_datadir}/keystone/main
...
%attr(0644, root, keystone) %{_datadir}/keystone/admin
%attr(0644, root, keystone) %{_datadir}/keystone/main
...
%config %attr(0640, keystone, keystone) %{_sysconfdir}/keystone/policy.json
