...
# follow patchs are ustack's patchs
Patch0010: 0010-Qemu-auto-create-pci-controller-alias-if-missing-from-domain-status.patch
...
BuildRequires: device-mapper
    %else
BuildRequires: device-mapper-devel >= 1.02.90
    %endif
%endif
%if %{with_storage_rbd}
...
Requires: device-mapper-libs >= 1.02.90
            %endif
